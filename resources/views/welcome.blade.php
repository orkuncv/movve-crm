...
<div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard', ['locale' => app()->getLocale()]) }}"
                       class="flex items-center space-x-2 font-extrabold">
                        <span class="text-3xl font-black gradient-text">crm.movve</span>
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <x-language-switcher/>
                    <a href="{{ route('login', ['locale' => app()->getLocale()]) }}" class="bg-indigo-600 text-white px-8 py-2 rounded-lg font-semibold text-lg hover:bg-indigo-700 transition-colors duration-200 w-full sm:w-auto shadow-md">Login</a>
                </div>
                <!-- Mobile menu button -->
        ...
        <div class="relative pt-32 pb-16 sm:pt-40 sm:pb-20 z-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h1 class="text-4xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                    <span class="gradient-text">Transform</span> Your
                    <br class="hidden sm:block" />
                    Customer Relations
                </h1>
                <p class="text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
                    Powerful, intuitive, and modern CRM solution designed to help your business grow and succeed in the digital age.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
                    ...
                    <div class="p-6 bg-gray-50 rounded-xl shadow-sm">
                        ...
                        <div class="text-gray-600">Average support response</div>
                    </div>
                    <div class="p-6 bg-gray-50 rounded-xl shadow-sm">
    ...
    <div class="bg-gray-50 py-24" id="features">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Everything you need, all in one place</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Our comprehensive CRM solution replaces multiple systems with one integrated platform</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg p-8 shadow-md hover:shadow-lg feature-card">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Customer Management</h3>
                    <p class="text-gray-600 mb-4">Efficiently manage and organize your customer data in one centralized location.</p>
                ...
                <div class="bg-white rounded-lg p-8 shadow-md hover:shadow-lg feature-card">
                    ...
                    <p class="text-gray-600 mb-4">Make data-driven decisions with powerful analytics and reporting tools.</p>
                    <a href="#" class="text-indigo-600 font-medium hover:text-indigo-700 inline-flex items-center">
                        Learn more
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <div class="bg-white rounded-lg p-8 shadow-md hover:shadow-lg feature-card">
                    ...
                    <p class="text-gray-600 mb-4">Streamline your workflow with intelligent automation features.</p>
                    <a href="#" class="text-indigo-600 font-medium hover:text-indigo-700 inline-flex items-center">
                        Learn more
                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
    ...
    <div class="bg-white py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Why choose Movve CRM?</h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">See how our solution compares to traditional systems</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <!-- Other Systems -->
                <div class="bg-gray-50 rounded-lg p-8 shadow-sm">
                    <h3 class="text-2xl font-bold text-gray-900 mb-6">With other systems</h3>
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-red-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                            <span class="text-gray-600">Multiple disconnected tools</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-red-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                            <span class="text-gray-600">Complex setup and maintenance</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-red-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                            <span class="text-gray-600">Higher total cost of ownership</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-indigo-50 rounded-lg p-8 shadow-sm border border-indigo-100">
                    <h3 class="text-2xl font-bold text-indigo-900 mb-6">With Movve CRM</h3>
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                            </svg>
                            <span class="text-gray-700">All-in-one integrated solution</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                            </svg>
                            <span class="text-gray-700">Easy setup and intuitive interface</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                            </svg>
                            <span class="text-gray-700">Predictable pricing with no hidden costs</span>
                        </li>
                    </ul>
                </div>
            </div>
