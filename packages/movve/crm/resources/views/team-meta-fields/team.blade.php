        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-800">{{ __('Meta Velden voor') }} {{ $team->name }}</h2>
                        <p class="mt-1 text-sm text-gray-600">{{ __('Beheer meta velden voor dit team. Meta velden kunnen worden gebruikt om extra informatie over contacten bij te houden, zoals het aantal winkelbezoeken.') }}</p>
                    </div>
                ...
                <div class="mt-6">
                    <a href="/teams/{{ $team->id }}" class="text-sm text-gray-600 hover:text-gray-900">
                        &larr; {{ __('Back to Team Settings') }}
                    </a>
                </div>
            </div>
        </div>
